...
mp=subprocess.Popen(['/usr/bin/mplayer','http:\\kdge-fm.akacast.akamaistream.net\7\259\20088\v1\auth.akacast.akamaistream.net\kdge-fm', '-novideo', '-ao', 'alsa', '-quiet'], stdout=subprocess.PIPE, stdin=subprocess.PIPE, stderr=subprocess.PIPE)
mpPID=mp.pid
